...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  } else if([@"getIosUUID" isEqualToString:call.method]) {
      result([FCUUID uuid]);
  } else if([@"getIosUUIDForSession" isEqualToString:call.method]) {
      result([FCUUID uuidForSession]);
  } else if([@"getIosUUIDForInstallation" isEqualToString:call.method]) {
      result([FCUUID uuidForInstallation]);
  } else if([@"getIosUUIDForVendor" isEqualToString:call.method]) {
      result([FCUUID uuidForVendor]);
  } else if([@"getIosUUIDForDevice" isEqualToString:call.method]) {
