...
class DeviceInfoPlugin {
  ...
  static Future<String> getIosUUID() async {
    return await channel.invokeMethod("getIosUUID");
  }

  /// 重新安装的时候会变
  static Future<String> getIosUUIDForInstallation() async {
    return await channel.invokeMethod("getIosUUIDForInstallation");
  }

  /// // 每次运行应用都会变
  static Future<String> getIosUUIDForSession() async {
    return await channel.invokeMethod("getIosUUIDForSession");
  }

  /// 卸载后重装会变
  static Future<String> getIosUUIDForVendor() async {
    return await channel.invokeMethod("getIosUUIDForVendor");
  }

  /// 抹掉iPhone的时候才会变，适合做唯一标识
  static Future<String> getIosUUIDForDevice() async {
    return await channel.invokeMethod("getIosUUIDForDevice");
  }
}
